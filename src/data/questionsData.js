export const questionsData = [
  ...
  },
  {
    ...
    text: 'Ви можете повернути або поміняти костюм протягом 14 днів. При поверненні, вартість відшкодуємо Вам на картку. З появою питань завжди можете зателефонувати до нашого менеджера за телефоном 0997181662. Обмін можна здійснити на інший товар котрий запропонує менеджер. Доставку сплачує магазин коли обмін здійснюється за вени магазину',
  },
];
